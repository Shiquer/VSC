                ...
                <main>
                        <section style={{ background: "linear-gradient(135deg, hsl(var(--primary)/0.08) 0%, hsl(var(--secondary)/0.15) 100%)", padding: "80px 0 60px" }}>
                                  <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "0 24px", textAlign: "center" }}>
                                              <div style={{ display: "inline-flex", alignItems: "center", gap: "8px", background: "hsl(var(--primary)/0.1)", borderRadius: "100px", padding: "6px 16px", marginBottom: "24px" }}>
                                                            ...
                                                            <span style={{ fontSize: "13px", color: "hsl(var(--primary))", fontWeight: "600" }}>Paris (75)</span>span>
                                              </div>div>
                        ...
                        <section style={sectionStyle}>
                                              ...
                                              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "48px", alignItems: "start" }}>
                                                            <div>
                                                                            <div style={{ display: "flex", alignItems: "center", gap: "16px", marginBottom: "24px" }}>
                                                                                              ...
                                                                                              <div>
                                                                                                                  <h2 style={{ fontSize: "1.4rem", fontWeight: "700", marginBottom: "4px" }}>Natalia Kourycheva</h2>h2>
                                                                                                                  <p style={{ color: "hsl(var(--muted-foreground))", fontSize: "0.95rem" }}>Psychanalyste &amp; Hypnothérapeute</p>p>
                                                                                                </div>div>
                                                                            </div>div>
                                                                            ...
                                                                            <div style={{ display: "flex", flexDirection: "column", gap: "16px", marginBottom: "32px" }}>
                                                                                              <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                                                                                                                  ...
                                                                                                                  <div>
                                                                                                                                        <p style={{ fontWeight: "600", fontSize: "0.9rem" }}>Téléphone</p>p>
                                                                                                                                        <a href="tel:+33675394716" style={{ color: "hsl(var(--primary))", fontSize: "0.85rem", textDecoration: "none", fontWeight: "500" }}>+33 6 75 39 47 16</a>a>
                                                                                                                    </div>div>
                                                                                                </div>div>
                                                                                              <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                                                                                                                  <div style={{ width: "40px", height: "40px", borderRadius: "10px", background: "hsl(var(--primary)/0.1)", display: "flex", alignItems: "center", justifyContent: "center" }}>
                                                                                                                  ...
                                                                                                                  <div>
                                                                                                                                        <p style={{ fontWeight: "600", fontSize: "0.9rem" }}>Cabinet</p>p>
                                                                                                                                        <a href="https://maps.google.com/?q=19+rue+de+Choiseul,+75002+Paris" target="_blank" rel="noopener noreferrer" style={{ color: "hsl(var(--primary))", fontSize: "0.85rem", textDecoration: "none", fontWeight: "500" }}>19 rue de Choiseul, 75002 Paris</a>a>
                                                                                                                    </div>div>
                                                                                                </div>div>
                                                                                              <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                                                                                                                  <div style={{ width: "40px", height: "40px", borderRadius: "10px", background: "hsl(var(--primary)/0.1)", display: "flex", alignItems: "center", justifyContent: "center" }}>
                                                                                                                  ...
                                                                                                                  <div>
                                                                                                                                        <p style={{ fontWeight: "600", fontSize: "0.9rem" }}>Séances disponibles</p>p>
                                                                                                                                        <p style={{ color: "hsl(var(--muted-foreground))", fontSize: "0.85rem" }}>En présentiel et à distance</p>p>
                                                                                                                    </div>div>
                                                                                                </div>div>
                                                                            </div>div>
                                                                            <div style={{ marginBottom: "32px" }}>
                                                                                              <h3 style={{ fontWeight: "700", marginBottom: "12px" }}>Certifications</h3>h3>
                                                                                              <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
                                                                                                {certifications.map((cert, i) => (
                                  <div key={i} style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                                                          <CheckCircle size={16} style={{ color: "hsl(var(--primary))", flexShrink: 0 }} />
                                                          <span style={{ fontSize: "0.9rem" }}>{cert}</span>span>
                                  </div>div>
                                ))}
                                                                                                </div>div>
                                                                            </div>div>
                                                                            <div>
                                                                                              <h3 style={{ fontWeight: "700", marginBottom: "16px" }}>Spécialités</h3>h3>
                                  ...
                                  <div key={i} style={{ padding: "12px", border: "1px solid hsl(var(--border))", borderRadius: "10px" }}>
                                                          ...
                                                          <p style={{ fontWeight: "600", fontSize: "0.85rem", marginBottom: "2px" }}>{s.title}</p>p>
                                                          <p style={{ color: "hsl(var(--muted-foreground))", fontSize: "0.78rem" }}>{s.description}</p>p>
                                  </div>div>
                                ))}
                                                                                                </div>div>
                                                                            </div>div>
                                                            ...
                                                            <div style={{ background: "hsl(var(--card))", border: "1px solid hsl(var(--border))", borderRadius: "16px", padding: "32px" }}>
                                                                            <h2 style={{ fontSize: "1.4rem", fontWeight: "700", marginBottom: "8px" }}>Envoyez un message</h2>h2>
                                                                            <p style={{ color: "hsl(var(--muted-foreground))", marginBottom: "24px", fontSize: "0.9rem" }}>Je vous répondrai dans les plus brefs délais.</p>p>
                                                              {formStatus === "success" && (
                              <div style={{ display: "flex", alignItems: "center", gap: "10px", background: "hsl(142 76% 36% / 0.1)", border: "1px solid hsl(142 76% 36% / 0.3)", borderRadius: "10px", padding: "14px 16px", marginBottom: "20px" }}>
                                                  ...
                                                  <span style={{ color: "hsl(142 76% 36%)", fontWeight: "600", fontSize: "0.9rem" }}>Message envoyé avec succès ! Je vous répondrai dans les meilleurs délais.</span>span>
                              </div>div>
                                                                            )}
                                                              {formStatus === "error" && (
                              <div style={{ display: "flex", alignItems: "center", gap: "10px", background: "hsl(0 84% 60% / 0.1)", border: "1px solid hsl(0 84% 60% / 0.3)", borderRadius: "10px", padding: "14px 16px", marginBottom: "20px" }}>
                                                  ...
                                                  <span style={{ color: "hsl(0 84% 60%)", fontWeight: "600", fontSize: "0.9rem" }}>Une erreur est survenue. Veuillez réessayer.</span>span>
                              </div>div>
                                                                            )}
                                                                            <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
                                                                                              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px" }}>
                                                                                                                  <div>
                                                                                                                                        <label style={labelStyle}>Prénom *</label>label>
                                                                                              ...
                                                                                              <div>
                                                                                                                  <label style={labelStyle}>Téléphone</label>label>
                                                                                                                  <input name="phone" type="tel" style={inputStyle} placeholder="06 XX XX XX XX" />
                                                                                                </div>div>
                                                                                              <div>
                                                                                                                  <label style={labelStyle}>Sujet *</label>label>
                                                                                                                  <select name="subject" required style={inputStyle}>
                                                                                                                                        <option value="">Choisissez un sujet</option>option>
                                                                                                                                        <option value="psychanalyse">Psychanalyse</option>option>
                                                                                                                                        <option value="hypnotherapie">Hypnothérapie</option>option>
                                                                                                                                        <option value="entreprise">Formation en entreprise</option>option>
                                                                                                                                        <option value="autre">Autre</option>option>
                                                                                                                    </select>select>
                                                                                                </div>div>
                                                                                              <div>
                                                                                              ...
                                                                                              <p style={{ fontSize: "12px", color: "hsl(var(--muted-foreground))", marginTop: "-8px" }}>* Champs obligatoires</p>p>
                                                                                              <button
                                                                                                                    type="submit"
