      ...
      <main style={{ display: "flex", alignItems: "flex-start", justifyContent: "center", minHeight: "calc(100vh - 140px)", padding: "60px 16px" }}>
        <div style={{ width: "100%", maxWidth: "480px" }}>
          ...
          <div style={{ textAlign: "center", marginBottom: "40px" }}>
            ...
            <h1 style={{ fontSize: "32px", fontWeight: "400", fontFamily: "'Playfair Display', Georgia, serif", color: "hsl(var(--foreground))", marginBottom: "10px" }}>
              Mon Espace
            </h1>
            <p style={{ fontSize: "15px", color: "hsl(var(--foreground))", opacity: 0.6, fontFamily: "'Helvetica Neue', sans-serif" }}>
              Connectez-vous ou faites une demande d'acces
            </p>
          </div>
            ...
            <div style={{ background: "#fff", borderRadius: "24px", border: "1px solid hsl(var(--border))", padding: "36px", boxShadow: "0 4px 32px rgba(0,0,0,0.06)" }}>
              {demandeSuccess ? (
                <div style={{ textAlign: "center", padding: "20px 0" }}>
                  ...
                  <p style={{ fontSize: "14px", color: "hsl(var(--foreground))", opacity: 0.6, lineHeight: "1.6", marginBottom: "24px", fontFamily: "'Helvetica Neue', sans-serif" }}>
                    Votre demande d'acces a bien ete transmise. Natalia vous contactera dans les meilleurs delais pour valider votre inscription.
                  </p>
                ...
                <>
                  ...
                  <p style={{ fontSize: "13px", color: "hsl(var(--foreground))", opacity: 0.5, marginBottom: "24px", fontFamily: "'Helvetica Neue', sans-serif" }}>
                    Remplissez ce formulaire pour demander un acces a votre espace patient. Natalia validera votre demande.
                  </p>
                  <form onSubmit={handleDemande} style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px" }}>
                      <div>
                        <label style={labelStyle}>Nom *</label>
                        <input type="text" placeholder="Dupont" value={demande.nom} onChange={e => setDemande(p => ({ ...p, nom: e.target.value }))} required style={inputSimple} />
                      </div>
                      <div>
                        <label style={labelStyle}>Prenom *</label>
                        <input type="text" placeholder="Marie" value={demande.prenom} onChange={e => setDemande(p => ({ ...p, prenom: e.target.value }))} required style={inputSimple} />
                      </div>
                    </div>
                    <div>
