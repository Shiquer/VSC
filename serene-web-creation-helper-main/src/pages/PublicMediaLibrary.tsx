...
const EmptyState = ({ text }: { text: string }) => (
    <div style={{ textAlign: "center", padding: "64px 0" }}>
          <p style={{ fontSize: "16px", color: "hsl(var(--foreground))", opacity: 0.5 }}>{text}</p>p>
    </div>div>
  );
          ...
          <div className="min-h-screen" style={{ background: "hsl(var(--background))" }}>
                  ...
                  {/* Hero */}
                        <section style={{ padding: "80px 0", background: "hsl(var(--secondary))" }}>
                                  <div className="container mx-auto px-8" style={{ textAlign: "center" }}>
                                              <span className="arise-badge" style={{ marginBottom: "24px", display: "inline-block" }}>Ressources gratuites</span>span>
                                              <h1 className="arise-serif" style={{ fontSize: "clamp(36px, 5vw, 56px)", fontWeight: "400", color: "hsl(var(--foreground))", marginBottom: "20px", marginTop: "16px" }}>Médiathèque</h1>h1>
                                              ...
                                              <div style={{ display: "flex", justifyContent: "center", gap: "16px", flexWrap: "wrap" }}>
                                                            <button className="arise-btn-primary"><Headphones style={{ width: "18px", height: "18px" }} />Explorer les audios</button>button>
                                                            <button className="arise-btn-outline"><Video style={{ width: "18px", height: "18px" }} />Voir les vidéos</button>button> <button className="arise-btn-outline"><BookOpen style={{ width: "18px", height: "18px" }} />Voir les articles</button>button>
                                              </div>div>
                                  </div>div>
                        </section>section>
            ...
            { value: "articles", icon: BookOpen, label: "Articles" },
                                                ...
                                                {/* Audio */}
                                                            <TabsContent value="audio">
                                                                            <div style={{ textAlign: "center", marginBottom: "40px" }}>
                                                                                              <h2 className="arise-serif" style={{ fontSize: "32px", fontWeight: "400", color: "hsl(var(--foreground))", marginBottom: "12px" }}>Séances Audio Guidées</h2>h2>
                                                                                              <p style={{ fontSize: "16px", color: "hsl(var(--foreground))", opacity: 0.7 }}>Des séances de sophrologie pour une pratique flexible et autonome</p>p>
                                                                            </div>div>
                                ...
                                {audioContent.map(audio => (
                                                      <div key={audio.id} style={cardStyle}
                                                                              ...
                                                                              <div style={{ padding: "28px" }}>
                                                                                                        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "12px" }}>
                                                                                                                                    <div style={{ flex: 1 }}>
                                                                                                                                                                  <h3 className="arise-serif" style={{ fontSize: "18px", fontWeight: "400", color: "hsl(var(--foreground))", marginBottom: "8px" }}>{audio.title}</h3>h3>
                                                                                                                                                                  <div style={{ display: "flex", gap: "6px", marginBottom: "8px" }}>
                                                                                                                                                                                                  <span style={badgeStyle()}>{audio.difficulty}</span>span>
                                                                                                                                                                                                  <span style={{ ...badgeStyle("hsl(var(--secondary))") }}>{audio.category}</span>span>
                                                                                                                                                                    </div>div>
                                                                                                                                      </div>div>
                                                                                                        ...
                                                                                                        <p style={{ fontSize: "14px", lineHeight: "1.6", color: "hsl(var(--foreground))", opacity: 0.7, marginBottom: "16px" }}>{audio.description || "Aucune description disponible"}</p>p>
                                                                                {currentPlaying === audio.id && (
                                                                                                        ...
                                                                                                        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                                                                                                                                    <div style={{ display: "flex", gap: "16px", fontSize: "13px", color: "hsl(var(--foreground))", opacity: 0.5 }}>
                                                                                                                                      {audio.duration && <span style={{ display: "flex", alignItems: "center", gap: "4px" }}><Clock style={{ width: "12px", height: "12px" }} />{audio.duration}</span>span>}
                                                                                                                                      {audio.downloads !== null && <span style={{ display: "flex", alignItems: "center", gap: "4px" }}><Download style={{ width: "12px", height: "12px" }} />{audio.downloads}</span>span>}
                                                                                                                                      </div>div>
                                                ...
                                                {/* Video */}
                                                            <TabsContent value="video">
                                                                            <div style={{ textAlign: "center", marginBottom: "40px" }}>
                                                                                              <h2 className="arise-serif" style={{ fontSize: "32px", fontWeight: "400", color: "hsl(var(--foreground))", marginBottom: "12px" }}>Contenus Vidéo</h2>h2>
                                                                                              <p style={{ fontSize: "16px", color: "hsl(var(--foreground))", opacity: 0.7 }}>Apprenez les techniques visuellement avec nos tutoriels et séances vidéo</p>p>
                                                                            </div>div>
                                ...
                                {videoContent.map(video => (
                                                      <div key={video.id} style={cardStyle}
                                                                              ...
                                                                              <div style={{ position: "relative", overflow: "hidden" }}>
                                                                                ...
                                                                                {video.duration && <span style={{ position: "absolute", top: "12px", right: "12px", background: "rgba(0,0,0,0.6)", color: "#fff", fontSize: "12px", fontWeight: "700", padding: "3px 8px", borderRadius: "99px" }}>{video.duration}</span>span>}
                                                                                </div>div>
                                                                              <div style={{ padding: "24px" }}>
                                                                                                        <div style={{ display: "flex", gap: "6px", marginBottom: "12px" }}>
                                                                                                                                    <span style={badgeStyle()}>{video.difficulty}</span>span>
                                                                                                                                    <span style={{ ...badgeStyle("hsl(var(--secondary))") }}>{video.category}</span>span>
                                                                                                          </div>div>
                                                                                                        <h3 className="arise-serif" style={{ fontSize: "18px", fontWeight: "400", color: "hsl(var(--foreground))", marginBottom: "8px" }}>{video.title}</h3>h3>
                                                                                                        <p style={{ fontSize: "13px", lineHeight: "1.6", color: "hsl(var(--foreground))", opacity: 0.7, marginBottom: "16px" }}>{video.description || "Aucune description disponible"}</p>p>
                                                                                {video.views !== null && <p style={{ fontSize: "12px", color: "hsl(var(--foreground))", opacity: 0.4, marginBottom: "16px" }}>{video.views} vues</p>p>}
                                                ...
                                                {/* Articles */}
                                                            <TabsContent value="articles">
                                                                            <div style={{ textAlign: "center", marginBottom: "40px" }}>
                                                                                              <h2 className="arise-serif" style={{ fontSize: "32px", fontWeight: "400", color: "hsl(var(--foreground))", marginBottom: "12px" }}>Articles de Blog</h2>h2>
                                                                                              <p style={{ fontSize: "16px", color: "hsl(var(--foreground))", opacity: 0.7 }}>Découvrez nos articles sur la sophrologie, le bien-être et la santé mentale</p>p>
                                                                            </div>div>
                                ...
                                {articles.map(article => (
                                                      <div key={article.id} style={cardStyle}
                                                                              ...
                                                                              <div style={{ padding: "24px", display: "flex", flexDirection: "column", flex: 1 }}>
                                                                                {article.category && <span style={{ ...badgeStyle("hsl(var(--secondary))"), marginBottom: "12px", display: "inline-block" }}>{article.category}</span>span>}
                                                                                                        <h3 className="arise-serif" style={{ fontSize: "18px", fontWeight: "400", color: "hsl(var(--foreground))", marginBottom: "8px", marginTop: "8px" }}>{article.title}</h3>h3>
                                                                                                        ...
                                                                                                        <Link to={`/article/${article.slug}`}>
                                                                                                                                    <button className="arise-btn-primary" style={{ width: "100%", justifyContent: "center" }}>Lire l'article</button>button>
                                                                                                          </Link>Link>
                                                                                </div>div>
                                                      </div>div>
                                                    ))}
                  ...
                  {/* Features */}
                        <section style={{ padding: "80px 0", background: "hsl(var(--secondary))" }}>
                                  <div className="container mx-auto px-8">
                                              <h2 className="arise-serif" style={{ fontSize: "clamp(26px, 3vw, 36px)", fontWeight: "400", color: "hsl(var(--foreground))", textAlign: "center", marginBottom: "48px" }}>Votre pratique, où que vous soyez</h2>h2>
            ...
            { icon: Book, title: "Contenu Exclusif", desc: "Accès à des séances exclusives créées spécialement pour nos clients." },
                                            ...
                                            <div key={title} style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "16px" }}>
                                                              ...
                                                              <h3 className="arise-serif" style={{ fontSize: "18px", fontWeight: "400", color: "hsl(var(--foreground))" }}>{title}</h3>h3>
                                                              <p style={{ fontSize: "14px", lineHeight: "1.7", color: "hsl(var(--foreground))", opacity: 0.7 }}>{desc}</p>p>
                                            </div>div>
                                          ))}
                                              </div>div>
                                  </div>div>
...
export default PublicMediaLibrary;</></></button>
