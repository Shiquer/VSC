                                    ...
                                    <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
                                                <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                                                              <div style={{ width: "44px", height: "44px", background: "hsl(var(--primary-foreground))", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center" }}>
                                                                              <span style={{ color: "hsl(var(--foreground))", fontFamily: "'Playfair Display', serif", fontWeight: "700", fontSize: "16px" }}>NK</span>span>
                                                              </div>div>
                                                              <div>
                                    ...
                                    <div>
                                                ...
                                                <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
                                                              <div style={{ display: "flex", alignItems: "flex-start", gap: "8px", color: "hsl(var(--primary-foreground))", opacity: 0.8 }}>
                                                                              ...
                                                                              <a href="https://maps.google.com/?q=19+rue+de+Choiseul,+75002+Paris" target="_blank" rel="noopener noreferrer" style={{ color: "inherit", textDecoration: "none", fontSize: "14px", lineHeight: "1.5" }}>19 rue de Choiseul, 75002 Paris</a>a>
                                                              </div>div>
                                                              <div style={{ display: "flex", alignItems: "center", gap: "8px", color: "hsl(var(--primary-foreground))", opacity: 0.8 }}>
                                                                              <Phone style={{ width: "16px", height: "16px" }} />
                                                                              <a href={`tel:${getHeaderContent("header_phone", "+33675394716")}`} style={{ color: "inherit", textDecoration: "none" }}><span style={{ fontSize: "14px" }}>{getHeaderContent("header_phone", "+33675394716")}</span>span></a>a>
                                                              </div>div>
                                                              <div style={{ display: "flex", alignItems: "center", gap: "8px", color: "hsl(var(--primary-foreground))", opacity: 0.8 }}>
                                                                              <Mail style={{ width: "16px", height: "16px" }} />
                                                                              <a href={`mailto:${getHeaderContent("header_email", "contact@example.com")}`} style={{ color: "inherit", textDecoration: "none", fontSize: "14px" }}>{getHeaderContent("header_email", "contact@example.com")}</a>a>
                                                              </div>div>
                                                </div>div>
                                    </div>div>
                    ...
                    {/* Bottom Bar */}
                          <div style={{ borderTop: "1px solid hsl(var(--primary-foreground) / 0.1)", padding: "24px 0", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "12px" }}>
                                    ...
                                    <div style={{ display: "flex", gap: "24px" }}>
                                                <Link to="/contact" style={{ fontSize: "13px", color: "hsl(var(--primary-foreground))", opacity: 0.5, textDecoration: "none" }}>Contact</Link>Link>
                                                <Link to="/reservation" style={{ fontSize: "13px", color: "hsl(var(--primary-foreground))", opacity: 0.5, textDecoration: "none" }}>Réservation</Link>Link>
                                    </div>div>
                          </div>div>
                  </div>div>
          </footer>footer>
